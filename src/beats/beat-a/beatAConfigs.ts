...
export const BEAT_A_014: BeatAConfig = {
  ...
  backLink: "/",
  headerTitle: "",
  introText: "You are a Declaring Agent. Build the correct permit for Case #014.",
  introSubtext: "Start by selecting Message Type below.",
...
export const BEAT_A_025: BeatAConfig = {
  ...
  introText: "You are a Declaring Agent. Build the correct permit for Case #025 \u2014 Apple MacBook Pro Import.",
  introSubtext: "Start by selecting Message Type below.",
...
export const BEAT_A_038: BeatAConfig = {
  ...
  introText: "You are a Declaring Agent. Build the correct permit for Case #038.",
  introSubtext: "Samsung OLED panels transiting through Singapore to Jakarta. Start by selecting Message Type.",
...
export const BEAT_A_052: BeatAConfig = {
  ...
  backLink: "/",
  headerTitle: "",
  introText: "You are a Declaring Agent. Build the correct permit for Case #052.",
  introSubtext: "Start by selecting Message Type below.",
