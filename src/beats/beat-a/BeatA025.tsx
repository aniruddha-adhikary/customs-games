...
export function BeatA025() {
  ...
  const setValue = useCallback(
    (field: string, value: string) => {
      ...
      setValues((prev) => {
        ...
        const errs = validatePermit025(next, scaffolding);
        setErrors(errs);
        errs.forEach((e) => {
  ...
  const handleSubmit = useCallback(() => {
    const errs = validatePermit025(values, scaffolding);
    ...
    setShowStamp(true);
    setTimeout(() => {
      const result = scorePermit025(values);
      setScore(result);
      setSubmitted(true);
    }, 1200);
  }, [values, scaffolding]);
    ...
    return (
      <div className="flex-1 flex flex-col">
        <header className="bg-customs-navy border-b border-customs-border px-3 sm:px-6 py-3 flex items-center gap-3 flex-shrink-0">
          <Link to="/case-025" className="text-customs-muted hover:text-white text-sm no-underline">
            &larr;
          </Link>
    ...
    <div className="flex-1 flex flex-col min-h-0">
      ...
      <header className="bg-customs-navy border-b border-customs-border px-3 sm:px-6 py-3 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-sm sm:text-base font-bold text-white">
            DECLARATION DESK &mdash; CASE #025
          </h1>
        </div>
            ...
            {!msgType && (
              <div className="bg-customs-panel border border-customs-gold/20 rounded-lg p-4 text-center animate-fade-in">
                <p className="text-customs-gold text-sm">
                  ...
                  #025 &mdash; Apple MacBook Pro Import.
                </p>
              ...
              <FormSection title="PLACE OF RELEASE / RECEIPT">
                {fieldVisible("placeOfReleaseFTZ") && (
                  <FormSelect
                    ...
                    tooltip={
                      scaffolding === 1
                        ? "Air freight arrives at Changi. Check the Air Waybill for the port of discharge."
                        : undefined
                    }
                    error={errors.find((e) => e.field === "placeOfReleaseFTZ")?.message}
                  />
                )}
            ...
            {msgType && (
              <FormSection title="GOODS DESCRIPTION">
                <FormField
                  ...
                  tooltip={
                    scaffolding === 1
                      ? "Portable digital automatic data processing machines (laptops, weight \u2264 10kg) = HS 8471.30"
                      : undefined
                  }
                ...
                <div className="grid grid-cols-2 gap-2">
                  <FormField
                    ...
                    tooltip={
                      scaffolding === 1
                        ? "Enter quantity in STCCED-prescribed unit. For laptops, it's U (units)."
                        : undefined
                    }
              ...
              <FormSection title="PACKING HIERARCHY">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <FormField
                    ...
                    tooltip={
                      scaffolding === 1
                        ? "Each pallet contains 10 individually-boxed laptops."
                        : undefined
                    }
                  />
                  <FormSelect
              ...
              <FormSection title="TRANSPORT">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <FormSelect
                    ...
                    tooltip={
                      scaffolding === 1
                        ? "Check the Air Waybill: flight number, port of loading."
                        : undefined
                    }
                  />
                </div>
            ...
            {msgType && (
              <FormSection title="VALUE DECLARATION">
                ...
                <FormField
                  ...
                  tooltip={
                    scaffolding === 1
                      ? "The invoice is CIF \u2014 freight & insurance are ALREADY included. Do NOT add them again."
                      : undefined
                  }
              ...
              <FormSection title="WEIGHT">
                <div className="grid grid-cols-2 gap-2">
                  <FormField
                    ...
                    tooltip={
                      scaffolding === 1
                        ? "Use the AWB gross weight. Air shipments = KGM."
                        : undefined
                    }
            ...
            {msgType && fieldVisible("paymentCondition") && (
              <FormSection title="PAYMENT">
                <FormSelect
                  ...
                  tooltip={
                    scaffolding === 1
                      ? "G1 = dutiable. GF = non-dutiable (GIRO). Laptops are NOT dutiable in Singapore."
                      : undefined
                  }
          ...
          <div className="w-80 sm:w-96 bg-customs-navy border-l border-customs-border overflow-auto animate-slide-in p-4 sm:p-6">
            ...
            <div className="space-y-3 text-xs text-customs-muted">
              ...
              <div>
                ...
                <p>Portable data processing machines (laptops) &le; 10kg: 8471.30. Declare to full digit level per STCCED 2022.</p>
              </div>
              <div>
                <h4 className="text-white font-medium mb-1">HS Qty Unit</h4>
                <p>STCCED 2022 unit for 8471.30 is U (units). Not KGM, not PCS.</p>
              </div>
              <div>
                <h4 className="text-white font-medium mb-1">CIF vs FOB</h4>
                <p>When INCOTERM = CIF, freight + insurance are INCLUDED. Do NOT add separately.</p>
                <p className="text-customs-amber mt-1">When INCOTERM = FOB, you must ADD freight + insurance to get CIF.</p>
              </div>
              <div>
                <h4 className="text-white font-medium mb-1">Gross Weight</h4>
                <p>Sea = TNE (metric tonnes). Air = KGM (kilograms).</p>
              </div>
              <div>
                <h4 className="text-white font-medium mb-1">Cargo Packing Type</h4>
                <p>Sea (containers) = 9. Air (pallets) = 5 (Non-containerised).</p>
              </div>
              <div>
                <h4 className="text-white font-medium mb-1">Payment</h4>
                <p>G1 = pay at approval (dutiable goods). GF = GIRO (non-dutiable).</p>
                <p className="text-customs-amber mt-1">Laptops are NOT dutiable. Only alcohol, tobacco, motor vehicles, petroleum are dutiable.</p>
              </div>
