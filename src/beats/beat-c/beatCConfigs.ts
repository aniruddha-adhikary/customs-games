...
export const BEAT_C_014: BeatCConfig = {
  ...
  briefingMission: 'Triage <span class="text-white font-bold">4 active permits</span> on the board. For each permit, decide the correct post-clearance action: <span class="text-customs-gold">Amend</span>, <span class="text-customs-gold">Cancel</span>, <span class="text-customs-gold">Refund</span>, or <span class="text-customs-gold">Monitor</span> (no action).',
  briefingIntel: [
    { icon: "", text: '&#9888;&#65039; A <span class="text-customs-amber font-medium">short shipment</span> has been reported on Case #014', highlightClass: "text-customs-amber" },
    { icon: "", text: '&#9203; One permit has a <span class="text-customs-red font-medium">same-day window</span> closing at midnight', highlightClass: "text-customs-red" },
    { icon: "", text: '&#128274; Some permits may be locked due to utilisation', highlightClass: "" },
    { icon: "", text: '&#128209; An approval from a Competent Authority is still pending', highlightClass: "" },
  ],
...
export const BEAT_C_025: BeatCConfig = {
  ...
  briefingStartTime: "23:41:07",
  briefingMission: 'Triage <span class="text-white font-bold">4 active permits</span> on the board. For each, decide: <span class="text-customs-gold">Amend</span>, <span class="text-customs-gold">Cancel</span>, <span class="text-customs-gold">Refund</span>, or <span class="text-customs-gold">Monitor</span>.',
  briefingIntel: [
    { icon: "", text: '&#9989; A <span class="text-customs-green font-medium">healthy permit</span> that needs no action', highlightClass: "text-customs-green" },
    { icon: "", text: '&#9203; One permit has a <span class="text-customs-red font-medium">same-day window</span> closing at midnight', highlightClass: "text-customs-red" },
    { icon: "", text: '&#128274; One permit is <span class="text-customs-red font-medium">locked</span> due to utilisation', highlightClass: "text-customs-red" },
    { icon: "", text: '&#128209; An <span class="text-customs-amber font-medium">HSA approval</span> is still pending', highlightClass: "text-customs-amber" },
  ],
...
export const BEAT_C_038: BeatCConfig = {
  ...
  briefingMission: 'Triage <span class="text-white font-bold">4 active permits</span> on the board. For each, decide: <span class="text-customs-gold">Amend</span>, <span class="text-customs-gold">Cancel</span>, <span class="text-customs-gold">Refund</span>, or <span class="text-customs-gold">Monitor</span>.',
  briefingIntel: [
    { icon: "", text: '&#9888;&#65039; A <span class="text-customs-amber font-medium">vessel delay</span> affects the Samsung transhipment', highlightClass: "text-customs-amber" },
    { icon: "", text: '&#9203; One permit has a <span class="text-customs-red font-medium">same-day window</span> closing', highlightClass: "text-customs-red" },
    { icon: "", text: '&#128274; Some permits may be locked due to utilisation', highlightClass: "" },
    { icon: "", text: '&#128209; An approval from a Competent Authority is still pending', highlightClass: "" },
  ],
...
export const BEAT_C_052: BeatCConfig = {
  ...
  briefingMission: 'Triage <span class="text-white font-bold">4 active permits</span> on the board. For each permit, decide the correct post-clearance action: <span class="text-customs-gold">Amend</span>, <span class="text-customs-gold">Cancel</span>, <span class="text-customs-gold">Refund</span>, or <span class="text-customs-gold">Monitor</span> (no action).',
  briefingIntel: [
    { icon: "", text: '&#9888;&#65039; A <span class="text-customs-amber font-medium">container number error</span> has been flagged on E-052', highlightClass: "text-customs-amber" },
    { icon: "", text: '&#128274; One permit is <span class="text-customs-red font-medium">locked</span> due to utilisation', highlightClass: "text-customs-red" },
    { icon: "", text: '&#10060; A buyer has <span class="text-customs-amber font-medium">cancelled an order</span>', highlightClass: "text-customs-amber" },
    { icon: "", text: '&#128209; A <span class="text-customs-amber font-medium">strategic goods</span> CA approval is pending', highlightClass: "text-customs-amber" },
  ],
